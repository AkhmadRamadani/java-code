                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      value.orderBox.values.first.menu![index]
                                          .nama,
                                      maxLines: 1,
                                      ...
                                      child: TextField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          prefixIconConstraints:
                                              BoxConstraints(maxWidth: 16),
                                          hintText: value.orderBox.values.first
                                              .menu![index].catatan,
                                          prefixIcon: Icon(
                                            Icons.notes,
                                            size: 12,
                                  ...
                                  Text(
                                    "Rp " +
                                        formatCurrency.format(value
                                            .orderBox.values.first.totalBayar).toString(),
                                    style: TextStyle(
                                        fontSize: 14,
                                        fontWeight: FontWeight.bold,
                                        color: colorConst.secondaryColor),
                              ...
                              onTap: () {
                                Get.defaultDialog(
                                  ...
                                  cancel: Padding(
                                    ...
                                    child: ButtonComponents(buttonTitle: "Oke"),
                                  ),
                                  content: Container(
                                    width: MediaQuery.of(context).size.width,
                                    padding:
                                    ...
                                    height: (40 *
                                            value
                                                .diskonResponse!.diskon!.length)
                                        .toDouble(),
                                    child: ListView.builder(
                                      itemCount:
                                          value.diskonResponse?.diskon?.length,
                                      shrinkWrap: true,
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "Rp " +
                                          value.getDiskonAmount().toString(),
                                      style: TextStyle(
                                          fontSize: 14,
                                          fontWeight: FontWeight.bold,
