...
class DetailMenuView extends GetView<MenuController> {
  DetailMenuView({Key? key, required this.menu}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        BerandaController prevController = Get.find();
  ...
  PersistentBottomSheetController showTopingBottomSheet(
      BuildContext context, MenuController menu) {
